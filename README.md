...
- Specific dependencies prevent to use a class
- Reuse tightly coupled component
- Multiple subclasses with similar behavior

#### Mediator design pattern pros

- Single responsibility
- Open-closed
- Reuse components

#### Mediator design pattern cons
